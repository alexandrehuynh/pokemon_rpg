...
// internal import
import shopImage from '../../assets/images/safarizone.jpg'; 
        ...
        <Root>
            ...
            <Main>
                <MainText>
                    ...
                    <Button sx={{ marginTop: '10px'}} component={Link} to={myAuth === 'true' ? "/safarizone" : "/auth"} variant='contained'>The Best of the Best Awaits. Enter when ready....</Button>
                </MainText>
            </Main>
        </Root>
    )
